...
public:
    ...
    static std::unique_ptr<Mesh> createMesh(hl::HHMesh* mesh, const Eigen::Affine3f& transformation,
                                            const Scene& scene);
    static std::unique_ptr<Instance> createInstance(hl::HHTerrainInstanceInfoV0* instance, hl::HHTerrainModel* model,
                                                    Scene& scene);
